...
{
    public partial class Form_QLCHCS : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void txtMaB_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtMaA_TextChanged(object sender, EventArgs e)
        {
