...
{
    public partial class Form_QLCH1 : DevExpress.XtraEditors.XtraForm
    {
        CauHoi_BAL_DLL cauhoi_bll_dal = new CauHoi_BAL_DLL();
        public ThiSinhBS tsbs;
        public delegate string MyGet();
        public MyGet LayGTri;
        public Form_QLCH1()
        {
            InitializeComponent();
